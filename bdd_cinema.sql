...
CREATE DATABASE IF NOT EXISTS `cinemaseb` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cinemaseb`;
...
INSERT INTO `movie` (`id_movie`, `movie_name`, `release_year`, `movie_length`, `synopsis`, `url_img`, `genre_id`, `director_id`, `note`) VALUES
	(1, 'The Dark Knight', '2008', '02:32:00', 'Batman aborde une phase décisive de sa guerre contre le crime à Gotham City...', 'https://c8.alamy.com/compfr/pm4kac/batman-the-dark-knight-poster-2008-warner-brothers-pm4kac.jpg', 1, 1, 4),
	(2, 'Batman And Robin', '1997', '02:05:00', 'À Gotham City, un nouveau méchant fait régner la terreur par le froid, Mister Freeze...', 'https://i.etsystatic.com/10683147/r/il/08db8a/1760961745/il_570xN.1760961745_2elb.jpg', 1, 2, 3),
	(3, 'American Psycho', '2000', '01:41:00', 'Patrick Bateman, 27 ans, flamboyant golden-boy du Wall Street d\'avant le krach d\'octobre 1987, est un dandy beau, riche et intelligent comme tous ses amis...', 'https://m.media-amazon.com/images/M/MV5BZTM2ZGJmNjQtN2UyOS00NjcxLWFjMDktMDE2NzMyNTZlZTBiXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg', 2, 3, 2),
	(4, 'Inception', '2010', '02:28:00', 'Dans un futur proche, les États-Unis ont développé ce qui est appelé le « rêve partagé », une méthode permettant d\'influencer l\'inconscient d\'une victime pendant qu\'elle rêve, donc à partir de son subconscient...', 'https://i.pinimg.com/originals/ae/29/e2/ae29e2656336cbf3d7fad3f6fe8cb1a4.jpg', 3, 1, 5),
	(5, 'Pulp Fiction', '1994', '02:25:00', 'Dans un café-restaurant de Los Angeles, dans la matinée, un couple de jeunes braqueurs, Pumpkin (appelé Ringo par Jules) et Yolanda (Tim Roth et Amanda Plummer), discutent des risques que comporte leur activité. Ils se décident finalement à attaquer le lieu, afin de pouvoir dévaliser à la fois l\'établissement et les clients.', 'https://static.posters.cz/image/1300/affiches-et-posters/pulp-fiction-cover-i1288.jpg', 2, 4, 4),
